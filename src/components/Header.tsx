    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#223549] px-10 py-3">
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-9">
          ...
          <Link className="text-white text-sm font-medium leading-normal" href="/about">About Us</Link>
          {/* <Link className="text-white text-sm font-medium leading-normal" href="/submit-project">Submit Project</Link> */}
        </div>
      </div>
      <div className="">
        {/* <Search onNav={true}/> */}
